...
public class ClientSideFrame extends JFrame {
	 ...
	 */
	public int updateServerCount (int count) {
		//String s=Integer.toString(count);
		this.lblServerCount.setText(String.valueOf(count));
		return count;
	}
	...
	/**
	 * This method creates and arrange Swing components to length retrieve from 
	 * the server.
 	 *
	 * @param font
	...
	private JPanel getServerDatePanel(Font font) {
		...
		// Create component to display length retrieve from the server
		JPanel panel = new JPanel();
		JLabel lblCount = new JLabel ("The Length of word success(from Server): ");
	...
	private void loadComponent() {
		...
		// Get server length's panel and add to frame
